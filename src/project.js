...
const TechPortfolio = () => {
  ...
  return (
    <div className="aboutbothers" id="project">
      <section className="wrapper" >
        <h1>Kene's Major Projects</h1>
        <div className="colls">
          <div className="coll" onTouchStart={handleCardHover}>
              ...
              <div className="back">
                <div className="inner">
                  <p>
                    ...
                    platform to search, compare, and reserve hotel
                    accommodations.
                  </p>
                </div>
              </div>
          ...
          <div className="coll" onTouchStart={handleCardHover}>
            <div className="containers">
              ...
              <div className="back">
                <div className="inner">
                  <p>
                    AI chatbot withd a predefined intent framework empowers
                    businesses to deliver efficient support to their customers
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="back">
                <div className="inner">
                  <p>
                    ...
                    administrative tasks and strengthens the school community as
                    a whole.
                  </p>
                </div>
              </div>
